...
\end{itemize}
À leur utilisation respective, un opérateur est ajouté dans la nomenclature. Ils doivent donc être définis à leur label respectif. Un argument optionnel permet d'ajouter des accents aux macros précédentes : \glsub[bar]{T}{v}, \glsubs[dot]{m}{v}{a}, \glsvi[][dot]{T}{m} et \glsvi[dot]{m}{k}.
