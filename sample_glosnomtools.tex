...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Document principal pour l'exemple d'utilisation de glosnomtools
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage{mathtools,siunitx,amsmath,amsfonts,amssymb,etoolbox}
...
\usepackage[noredefwarn]{glossaries} % aucun warning pour remplacements 
								     % de la classe memoir
\usepackage{glosnomtools}			 % package de francis gagnon
%% ===================== preamble ============================================
%% ------------- glossaries ------------------------------------------------
\makeglossaries
...
%% ------------- ulthese ----------------------------------------------------
\titre{Exemple d'une nomenclature mathématique avec \texttt{glossaries} et \texttt{glosnomtools} dans \texttt{ulthese}}
